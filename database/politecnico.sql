...
CREATE TABLE `decano` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_decano_usuario1_idx` (`usuario_id`),
  CONSTRAINT `fk_decano_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
...
INSERT INTO `decano` VALUES (1,'Mecánica',1),(2,'Electrónica',2),(3,'Alimentos',3),(4,'Industrial',4),(5,'Sistemas',5),(6,'Agronomía',6),(7,'Física',7),(8,'Ambiental',8),(9,'Civil',9),(10,'Química',10),(11,'Matemática',11),(12,'Agronomía',12),(13,'Electrónica',13),(14,'Industrial',14),(15,'Física',15),(16,'Fisica',16),(17,'Matemática',17),(18,'Mecánica',18),(19,'Química',19),(20,'Industrial',20),(21,'Industrial',21),(22,'Sistemas',22),(23,'Civil',23),(24,'Mecánica',24),(25,'Fisica',25),(26,'Matemática',26),(27,'Electrónica',27),(28,'Química',28),(29,'Alimentos',29),(30,'Industrial',30);
...
INSERT INTO `estado_reunion` VALUES (1,'Creada'),(2,'Editada'),(3,'Aceptada'),(4,'Rechazada'),(5,'Eliminada'),(6,'Realizada');
...
CREATE TABLE `estudiante` (
  ...
  `periodo_de_admision` varchar(45) NOT NULL,
  `tipo_de_admision` varchar(45) NOT NULL,
  `horario` varchar(45) DEFAULT NULL,
  `progreso_de_carrera` varchar(45) DEFAULT NULL,
  `profesor_id` int NOT NULL,
  `usuario_id` int NOT NULL,
  PRIMARY KEY (`id`,`profesor_id`),
  KEY `fk_estudiante_usuario1_idx` (`id`),
  KEY `fk_estudiante_profesor1_idx` (`profesor_id`),
  KEY `fk_estudiante_usuario1_idx1` (`usuario_id`),
  CONSTRAINT `fk_estudiante_profesor1` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`),
  CONSTRAINT `fk_estudiante_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `estudiante` VALUES (61,'Industrial',2.85,'Activo','Segundo Semestre 2017/2018','Primera',NULL,NULL,34,61),(62,'Física',3,'Activo','Primer Semestre 2018/2019','Tercera',NULL,NULL,38,62),(63,'Mecánica',4,'Activo','Segundo Semestre 2018/2019','Segunda',NULL,NULL,31,63),(64,'Matemática',3.2,'Activo','Segundo Semestre 2018/2019','Primera',NULL,NULL,39,64),(65,'Sistemas',2.9,'Inactivo','Segundo Semestre 2018/2019','Segunda',NULL,NULL,35,65),(66,'Alimentos',2.3,'Activo','Segundo Semestre 2017/2018','Tercera',NULL,NULL,32,66),(67,'Química',1.9,'Inactivo','Primer Semestre 2018/2019','Primera',NULL,NULL,40,67),(68,'Civil',2.4,'Activo','Primer Semestre 2019/2020','Segunda',NULL,NULL,41,68),(69,'Electrónica',1.5,'Activo','Primer Semestre 2019/2020','Tercera',NULL,NULL,42,69),(70,'Agronomía',2.8,'Activo','Segundo Semestre 2019/2020','Primera',NULL,NULL,33,70),(71,'Civil',3.2,'Inactivo','Segundo Semestre 2019/2020','Segunda',NULL,NULL,41,71),(72,'Electrónica',2.9,'Activo','Segundo Semestre 2017/2018','Tercera',NULL,NULL,42,72),(73,'Sistemas',1.6,'Inactivo','Primer Semestre 2018/2019','Tercera',NULL,NULL,35,73),(74,'Física',4,'Inactivo','Primer Semestre 2018/2019','Segunda',NULL,NULL,38,74),(75,'Matemática',3.7,'Activo','Primer Semestre 2016/2017','Primera',NULL,NULL,39,75),(76,'Sistemas',3.5,'Activo','Segundo Semestre 2016/2017','Primera',NULL,NULL,58,76),(77,'Industrial',3.7,'Activo','Primer Semestre 2017/2018','Primera',NULL,NULL,44,77),(78,'Matemática',2.9,'Activo','Primer Semestre 2017/2018','Primera',NULL,NULL,51,78),(79,'Industrial',2.8,'Activo','Primer Semestre 2017/2018','Segunda',NULL,NULL,46,79),(80,'Industrial',2.7,'Activo','Segundo Semestre 2017/2018','Segunda',NULL,NULL,47,80),(81,'Electrónica',3.1,'Activo','Segundo Semestre 2017/2018','Primera',NULL,NULL,45,81),(82,'Electrónica',3.3,'Activo','Primer Semestre 2016/2017','Tercera',NULL,NULL,45,82),(83,'Civil',3.7,'Activo','Segundo Semestre 2016/2017','Primera',NULL,NULL,49,83),(84,'Civil',3.9,'Inactivo','Segundo Semestre 2017/2018','Primera',NULL,NULL,49,84),(85,'Industrial',3,'Inactivo','Segundo Semestre 2017/2018','Segunda',NULL,NULL,47,85),(86,'Alimentos',3,'Inactivo','Primer Semestre 2016/2017','Primera',NULL,NULL,32,86),(87,'Alimentos',3.8,'Activo','Segundo Semestre 2016/2017','Primera',NULL,NULL,32,87),(88,'Química',3.1,'Activo','Primer Semestre 2017/2018','Segunda',NULL,NULL,55,88),(89,'Química',2.7,'Inactivo','Primer Semestre 2016/2017','Tercera',NULL,NULL,55,89),(90,'Química',2.5,'Inactivo','Primer Semestre 2017/2018','Primera',NULL,NULL,55,90);
...
CREATE TABLE `profesor` (
  ...
  CONSTRAINT `fk_profesor_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `profesor` VALUES (31,'Mecánica',31),(32,'Alimentos',32),(33,'Agronomía',33),(34,'Industrial',34),(35,'Sistemas',35),(36,'Electrónica',36),(37,'Civil',37),(38,'Física',38),(39,'Matemática',39),(40,'Química',40),(41,'Civil',41),(42,'Electrónica',42),(43,'Ambiental',43),(44,'Industrial',44),(45,'Electrónica',45),(46,'Industrial',46),(47,'Industrial',47),(48,'Mecánica',48),(49,'Civil',49),(50,'Agronomía',50),(51,'Matemática',51),(52,'Electrónica',52),(53,'Física',53),(54,'Electrónica',54),(55,'Química',55),(56,'Física',56),(57,'Industrial',57),(58,'Sistemas',58),(59,'Química',59),(60,'Civil',60);
...
CREATE TABLE `reunion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_reunion_profesor1_idx` (`profesor_id`),
  KEY `fk_reunion_estudiante1_idx` (`estudiante_id`),
  KEY `fk_reunion_estado_reunion1_idx` (`estado_id`),
  CONSTRAINT `fk_reunion_estado_reunion1` FOREIGN KEY (`estado_id`) REFERENCES `estado_reunion` (`id`),
  CONSTRAINT `fk_reunion_estudiante1` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_reunion_profesor1` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`)
...
INSERT INTO `reunion` VALUES (30,'sdfsdf','sdfsdfsdf','2020-10-26 13:45:00',NULL,NULL,NULL,38,62,1,'2020-10-26 14:32:33','Pedro Portilla',NULL,NULL);
...
/*!50001 VIEW `estudiante_view` AS select `usuario`.`id` AS `id`,`usuario`.`codigo` AS `codigo`,`usuario`.`correo_institucional` AS `correo_institucional`,`usuario`.`hash` AS `hash`,`usuario`.`nombres` AS `nombres`,`usuario`.`apellidos` AS `apellidos`,`usuario`.`correo_personal` AS `correo_personal`,`usuario`.`telefono` AS `telefono`,`estudiante`.`carrera` AS `carrera`,`estudiante`.`gpa` AS `gpa`,`estudiante`.`status` AS `status`,`estudiante`.`periodo_de_admision` AS `periodo_de_admision`,`estudiante`.`tipo_de_admision` AS `tipo_de_admision`,`estudiante`.`profesor_id` AS `profesor_id` from (`usuario` join `estudiante` on((`usuario`.`id` = `estudiante`.`usuario_id`))) where (`usuario`.`rol_id` = 3) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `profesor_view` AS select `usuario`.`id` AS `id`,`usuario`.`codigo` AS `codigo`,`usuario`.`nombres` AS `nombres`,`usuario`.`apellidos` AS `apellidos`,`usuario`.`hash` AS `hash`,`profesor`.`carrera` AS `carrera`,`usuario`.`correo_institucional` AS `correo_institucional`,`usuario`.`correo_personal` AS `correo_personal`,`usuario`.`telefono` AS `telefono` from (`usuario` join `profesor` on((`usuario`.`id` = `profesor`.`usuario_id`))) where (`usuario`.`rol_id` = 2) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `reunion_view` AS select `reunion`.`id` AS `id`,`reunion`.`tema` AS `tema`,`reunion`.`descripcion` AS `descripcion`,`reunion`.`fecha` AS `fecha`,`reunion`.`profesor_id` AS `profesor_id`,`profesor_view`.`nombres` AS `nombres_profesor`,`profesor_view`.`apellidos` AS `apellidos_profesor`,`reunion`.`estudiante_id` AS `estudiante_id`,`estudiante_view`.`nombres` AS `nombres_estudiante`,`estudiante_view`.`apellidos` AS `apellidos_estudiante`,`reunion`.`estado_id` AS `estado_id`,`estado_reunion`.`estado` AS `estado` from (((`reunion` join `profesor_view` on((`profesor_view`.`id` = `reunion`.`profesor_id`))) join `estudiante_view` on((`estudiante_view`.`id` = `reunion`.`estudiante_id`))) join `estado_reunion` on((`estado_reunion`.`id` = `reunion`.`estado_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-10-26 14:36:26
